...
try {
  ...
  console.log(error);
  toast.error("something went wrong in submitupdate")
}
...
const handleDelete = async(id)=>{
  try {
    ...
    console.log(error);
    toast.error("something went wrong in deletebutton")
  }
...
const getAllCategory = async()=>{
  try {
    ...
    console.log(error);
    toast.error("something went wrong in getting catogery")
  }
}
...
getAllCategory();
  ...
  <tbody>
      ...
      {categories?.map((c)=>(
        <>
        <tr>
        <td scope="col" key={c._id}>{c.name}</td>
        <td scope='col'>
